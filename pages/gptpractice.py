...
if "messages" not in st.session_state:
    ...
    #if st.session_state['messages'].empty():
        #st.session_state.messages.append({"role": "system", "content": "You are a friendly and polite assistant. Always respond in a kind and helpful manner."})
